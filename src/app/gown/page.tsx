...
const page = () => {
  ...
  return (
    <section className="w-full bg-gray-50 py-8 md:py-14">
       <h2 className="text-center text-pink-600 tracking-[0.3em] uppercase text-lg mb-10">
          Explore Our Gowns
        </h2>
                    ...
                    <div className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition duration-300 hover:-translate-y-2 cursor-pointer h-full">
                      ...
                      <div className="px-4 py-3">
                        ...
                        <p className="text-lg font-bold mt-1">{item.price}</p>
                         ...
                         <button className="mt-3 w-full bg-pink-600 text-white py-2 rounded-lg text-sm hover:bg-pink-700 transition cursor-pointer">
                      View Details
                    </button>
                      </div>
                    </div>
